...
export default function ClubeDasMigasExAssinanteScreen() {
  const handleGoBack = () => {
    router.back();
  };

  const handleLearnMore = () => {
    // Navigate to learn more about benefits
  };
        ...
        >
          <View style={styles.headerOverlay}>
            ...
            <View style={styles.mainContent}>
              <Text style={styles.mainTitle}>Assine e ganhe benefícios exclusivos!</Text>
              
              <TouchableOpacity style={styles.learnMoreButton} onPress={handleLearnMore}>
                <Text style={styles.learnMoreText}>Saiba mais sobre assinatura</Text>
        ...
        <View style={styles.benefitsSection}>
          <View style={styles.benefitsGrid}>
            <View style={styles.benefitItem}>
              ...
              <Text style={styles.benefitTitle}>Volte a ter uma assinatura Premium</Text>
            </View>
