...
export default function ProfileExAssinanteTab() {
  const handleHelpPress = () => {
    router.push('/help');
  };

  const handleClubePress = () => {
    router.push('/clube-das-migas-ex-assinante');
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        {/* Premium Card - Reactivation */}
        <View style={styles.premiumCard}>
          <View style={styles.premiumCardContent}>
            <Text style={styles.premiumTitle}>Assinatura Premium</Text>
            <Text style={styles.premiumSubtitle}>Volte a ser uma assinante Premium</Text>
            <TouchableOpacity style={styles.premiumButton} onPress={handleSubscribePremium}>
              <Text style={styles.premiumButtonText}>Ganhe mais benefícios e exclusividades no app</Text>
        ...
        {/* Subscription Link */}
        <View style={styles.subscriptionLinkContainer}>
          <View style={styles.subscriptionLink}>
            <Text style={styles.subscriptionLinkText}>Volte a ser uma assinante Premium</Text>
            <Text style={styles.subscriptionSubtext}>- Página de assinatura</Text>
          </View>
        </View>
        ...
        <View style={styles.notificationsList}>
          <View style={styles.notificationItem}>
            ...
            <View style={styles.notificationContent}>
              ...
              <Text style={styles.notificationText}>Nossa nova coleção já está disponível! Confira</Text>
            </View>
          </View>
        </View>
