...
export default function ProfileAssinanteAtivaTab() {
  const handleHelpPress = () => {
    router.push('/help');
  };

  const handleClubePress = () => {
    router.push('/clube-das-migas-assinante');
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        {/* Premium Card - Active Subscription */}
        <View style={styles.premiumCard}>
          <View style={styles.premiumCardContent}>
            <Text style={styles.premiumTitle}>Assinatura Premium</Text>
            <Text style={styles.premiumSubtitle}>Gerencie sua assinatura e consulte seu histórico</Text>
            <TouchableOpacity style={styles.premiumButton} onPress={handleManageSubscription}>
              <Text style={styles.premiumButtonText}>Gerenciar assinatura</Text>
